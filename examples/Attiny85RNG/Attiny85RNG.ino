...
void setup()
{
    ...
    // up to 255 and overflow to 0 and continue counting until the power is cut.
...
void loop()
{
    // Since the 'Deck of dice' is only expected to be shuffled at start or at input, we can collect random seed at user input
